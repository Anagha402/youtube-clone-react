...
function PlayVideo() {
  ...
  return (
    ...
    <div className="publisher">
        ...
        <div>
            <p style={{color:"#000", fontWeight:'600', fontSize:"18px"}}> {apiData? apiData.snippet.channelTitle : ""} <br /><span style={{fontSize:"15px", color:"#5a5a5a"}}>{channelData?value_converter(channelData.statistics.subscriberCount):'1M'} Subscribers</span></p>
